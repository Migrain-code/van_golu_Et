...
class PersonelController extends Controller
{
    public function index()
    {
        ...
        if ($business){
            return view('admin.business.personels.index', compact('business', 'businessTypes'));
        } else{
    ...
    public function edit(Personel $personel)
    {
        ...
        return view('admin.business.personels.detail.show', compact('personel', 'appointmentRanges', 'dayList', 'restDays', 'workTimes', 'genderTypes', 'womanServices', 'manServices', 'unisexServices'));
    }
