...
class BusinessController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.business.index', compact('categories', 'dayList', 'appointmentRanges'));
    }
    ...
    public function edit(Business $business)
    {
        ...
        return view('admin.business.detail.show', compact('categories', 'business', 'months', 'customers'));
    }
    ...
    public function settings(Business $business)
    {
        ...
        return view('admin.business.detail.settings', compact('business', 'businessTypes', 'dayList', 'appointmentRanges'));
    }
