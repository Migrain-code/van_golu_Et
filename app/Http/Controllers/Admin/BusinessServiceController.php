...
class BusinessServiceController extends Controller
{
    public function index()
    {
        ...
        if ($business){
            return view('admin.business.services.index', compact('business', 'categories', 'businessTypes'));
        } else{
    ...
    public function edit(BusinessService $businessService)
    {
        ...
        $businessTypes = BusinnessType::all();
        if ($business){
            return view('admin.business.services.detail.edit', compact('business', 'categories', 'businessTypes', 'businessService'));
        } else{
            return back()->with('response', [
                'status' => "error",
                'message' => "İşletme Bulunamadı"
