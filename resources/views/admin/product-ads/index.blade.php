...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-muted">Ürün Reklamarı</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
@section('content')
    <div id="kt_app_content_container" class="app-container container-xxl">
        ...
        <div class="card">
            <!--begin::Card header-->
            @include('admin.ads.components.toolbar')
            <!--end::Card header-->
            <!--begin::Card body-->
        ...
        <!--end::Card-->
        <!--begin::Modals-->
        @include('admin.product-ads.components.add-advert')
        @include('admin.product-ads.components.export-modal')
        <!--end::Modals-->
    </div>
...
@section('scripts')
    <script>
        let DATA_URL = "{{route('admin.productAdvert.datatable')}}";
        let DATA_COLUMNS = [
            {data: 'id'},
            {data: 'name'},
            {data: 'link'},
    ...
    <script src="/assets/js/project/product-ads/listing.js"></script>
    <script src="/assets/js/project/product-ads/add.js"></script>
