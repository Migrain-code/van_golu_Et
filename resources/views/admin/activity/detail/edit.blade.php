...
@section('content')
    <div id="kt_app_content_container" class="app-container container-xxl">
        ...
        <div class="card">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        ...
                        <button type="button" class="btn btn-primary me-2" data-bs-toggle="modal"
                                data-bs-target="#kt_modal_personal_list">Katılımcılar
                        </button>
                        <!--end::Add customer-->
                        <!--begin::Add customer-->
                        <button type="button" class="btn btn-info me-2" data-bs-toggle="modal"
                                data-bs-target="#kt_modal_activity_sponsor_list">Sponsorlar
                        </button>
                        <!--end::Add customer-->
                    </div>
            ...
            <div class="card-body pt-0">
                <form class="form" action="{{route('admin.activity.update', $activity->id)}}" method="post"
                      id="kt_modal_add_customer_form" enctype="multipart/form-data" data-kt-redirect="">
                    <!--begin::Modal body-->
                    @csrf
                    @method('PUT')
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="tab-content" id="myTabContent">
                            @include('admin.activity.detail.tabs.tab1')
                            @include('admin.activity.detail.tabs.tab2')
                            @include('admin.activity.detail.tabs.tab3')
                            @include('admin.activity.detail.tabs.tab4')
                        </div>
                        <!--end::Scroll-->
                    </div>
                    <!--end::Modal body-->
                    ...
                    <div class="modal-footer flex-center">
                        <!--begin::Button-->
                        <button type="reset" id="kt_modal_add_customer_cancel" class="btn btn-light me-3">Discard
                        </button>
                        <!--end::Button-->
                        <!--begin::Button-->
    ...
    <!--end::Card-->
    @include('admin.activity.detail.modals.add-sponsor')
    @include('admin.activity.detail.modals.personals')
    @include('admin.activity.detail.modals.sponsor-list')
    </div>
