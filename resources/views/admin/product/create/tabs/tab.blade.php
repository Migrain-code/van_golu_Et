<div class="tab-pane fade @if($loop->first) show active @endif" id="kt_tab_pane_{{$row->code}}" role="tabpanel">
    ...
    <div class="fv-row mb-7">
        <!--begin::Label-->
        <label class="required fs-6 fw-semibold mb-2">Html Açıklama</label>
        <!--end::Label-->
        <!--begin::Input-->
        <textarea class="form-control form-control-solid tinyMiceEditor" rows="7" placeholder="" name="advantage[{{$row->code}}]"></textarea>
        <!--end::Input-->
    </div>
   ,
</div>
