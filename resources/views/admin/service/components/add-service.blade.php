        ...
        <div class="modal-content">
            ...
            <form class="form" action="#" id="kt_modal_add_customer_form" enctype="multipart/form-data" data-kt-redirect="">
                ...
                <div class="modal-header" id="kt_modal_add_customer_header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bold">Hizmet Oluştur</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="kt_tab_pane_1" role="tabpanel">
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
                                    <label class="required fs-6 fw-semibold mb-2">Hizmet Adı (Türkçe)</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                ...
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
                                    <label class="required fs-6 fw-semibold mb-2">Hizmet Adı (İngilizce)</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                ...
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
                                    <label class="required fs-6 fw-semibold mb-2">Hizmet Adı (Almanca)</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                ...
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
                                    <label class="required fs-6 fw-semibold mb-2">Hizmet Adı (İspanyolca)</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                ...
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
                                    <label class="required fs-6 fw-semibold mb-2">Hizmet Adı (Fransızca)</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                ...
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
                                    <label class="required fs-6 fw-semibold mb-2">Hizmet Adı (İtalyanca)</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                            ...
                            <div class="tab-pane fade" id="kt_tab_pane_2" role="tabpanel">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <label class="fs-6 fw-semibold mb-2">
                                        ...
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Hizmet Görseli zorunludur"></i>
                                    </label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
