    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        ...
        <div class="card">
            ...
            <div class="card-body pt-0">
                <form class="form" action="{{route('admin.reference.update', $reference->id)}}" method="post" id="kt_modal_add_faq_form" enctype="multipart/form-data" data-kt-redirect="">
                    <!--begin::Modal body-->
                    @csrf
                    @method('PUT')
                    <div class="modal-body py-10 px-lg-17">
                        <!--begin::Scroll-->
                            ...
                            <div class="tab-content" id="myTabContent">
                                @foreach($languages as $row)
                                    @include('admin.reference.edit.tabs.tab')
                                @endforeach
                                @include('admin.reference.edit.tabs.other')
