        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x border-transparent fs-4 fw-semibold mb-15">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-active-primary" data-bs-toggle="tab" href="#kt_ecommerce_settings_contact">
                            ...
                            <!--end::Svg Icon-->İletişim Ayarları
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-active-primary" data-bs-toggle="tab" href="#kt_ecommerce_settings_social">
                            ...
                            <!--end::Svg Icon-->Sosyal Medya Ayarları
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-active-primary" data-bs-toggle="tab" href="#kt_ecommerce_settings_contact_info">
                            <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm005.svg-->
                            <span class="svg-icon svg-icon-2 me-2">
                                 <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="tab-content" id="myTabContent">
                    @include('settings.customer.tabs.tab1')
                    @include('settings.customer.tabs.tab2')
...
@section('scripts')
    <script>
        $('[name="birthday_is_sms"]').on('change', function () {
            let checkbox = $(this);
