...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-muted">Ürün Kategorileri</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
...
@section('scripts')
    <script>
        let DATA_URL = "{{route('admin.productCategory.datatable')}}";
        let DATA_COLUMNS = [
            {data: 'id'},
            {data: 'name'},
            {data: 'status'},
        ...
        let addUrl = "{{route('admin.productCategory.store')}}"
    </script>
