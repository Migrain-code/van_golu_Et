				...
				validator.validate().then(function (status) {
					...
					if (status == 'Valid') {
						...
						setTimeout(function() {
                            ...
                            formData.append("meta_title[de]", $('[name="meta_title[de]"]').val());
                            formData.append("meta_title[en]", $('[name="meta_title[en]"]').val());
                            formData.append("meta_title[es]", $('[name="meta_title[es]"]').val());
                            formData.append("meta_title[fr]", $('[name="meta_title[fr]"]').val());
                            formData.append("meta_title[it]", $('[name="meta_title[it]"]').val());
                            formData.append("meta_title[tr]", $('[name="meta_title[tr]"]').val());
                            ...
                            formData.append("category_id", $('[name="category"]').val());
                            formData.append("image", $('[name="image"]')[0].files[0]);

                            $.ajax({
                                url: '/dashboard/customerBlog',
                                type: "POST",
                                data: formData,
                                processData: false,
                                contentType: false,
