			...
			form,
			{
				fields: {
					'name[de]': {
						validators: {
							notEmpty: {
								message: 'Ad (de) alanı gereklidir'
							}
						}
					},
                    'name[en]': {
                        validators: {
                            notEmpty: {
                                message: 'Ad (en) alanı gereklidir'
                            }
                        }
                    },
                    'name[es]': {
                        validators: {
                            notEmpty: {
                                message: 'Ad (es) alanı gereklidir'
                            }
                        }
                    },
                    'name[fr]': {
                        validators: {
                            notEmpty: {
                                message: 'Ad (fr) alanı gereklidir'
                            }
                        }
                    },
                    'name[it]': {
                        validators: {
                            notEmpty: {
                                message: 'Ad (it) alanı gereklidir'
                            }
                        }
                    },
                    'name[tr]': {
                        validators: {
                            notEmpty: {
                                message: 'Ad (tr) alanı gereklidir'
                            }
                        }
                    },
				},
				...
				validator.validate().then(function (status) {
					...
					if (status == 'Valid') {
						...
						setTimeout(function() {
                            ...
                            $.ajax({
                                url: '/dashboard/businessFaqCategory',
                                type: "POST",
                                data: formData,
                                processData: false,
                                contentType: false,
