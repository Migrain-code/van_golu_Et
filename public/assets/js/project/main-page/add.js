				...
				validator.validate().then(function (status) {
					...
					if (status == 'Valid') {
						...
						setTimeout(function() {
                            ...
                            formData.append("button_text[de]", $('[name="button_text[de]"]').val());
                            formData.append("button_text[en]", $('[name="button_text[en]"]').val());
                            formData.append("button_text[es]", $('[name="button_text[es]"]').val());
                            formData.append("button_text[fr]", $('[name="button_text[fr]"]').val());
                            formData.append("button_text[it]", $('[name="button_text[it]"]').val());
                            formData.append("button_text[tr]", $('[name="button_text[tr]"]').val());
                            ...
                            $.ajax({
                                ...
                                success: function (res) {
                                        ...
                                        Swal.fire({
                                            text: "Alan Başarılı Bir Şekilde Kayıt Edildi!",
                                            icon: "success",
